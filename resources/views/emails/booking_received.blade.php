...
<head>
    ...
    <title>Booking Received — AutoMateX</title>
</head>
...
<table width="100%" style="max-width:620px;" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td style="vertical-align:middle;text-align:right;">
                        <div style="font-size:22px;font-weight:800;color:#ffffff;letter-spacing:0.06em;line-height:1;">
                            BOOKING&nbsp;<span style="color:#fbbf24;">RECEIVED</span>
                        </div>
    ...
    {{-- ── Status strip ──────────────────────────────────────── --}}
    <tr>
        <td style="background:#1a1400;border-top:2px solid #fbbf24;padding:16px 36px;text-align:center;">
            <div style="display:inline-block;background:#fef9c3;border:1px solid #fde047;border-radius:20px;padding:5px 16px;">
                <span style="display:inline-block;width:7px;height:7px;border-radius:50%;background:#f59e0b;vertical-align:middle;margin-right:6px;"></span>
                <span style="font-family:'Courier New',monospace;font-size:11px;font-weight:700;color:#92400e;letter-spacing:0.08em;vertical-align:middle;">BOOKING SUBMITTED — PENDING CONFIRMATION</span>
            </div>
            <div style="color:#94a3b8;font-size:13px;margin-top:8px;">
                Your booking at <strong style="color:#f97316;">{{ $booking->garage->name }}</strong> has been received. You will be notified once the garage confirms your appointment.
            </div>
        </td>
    </tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                    <td width="48%" style="vertical-align:top;background:#f8fafc;border:1px solid #e2e8f0;border-top:3px solid #f97316;border-radius:10px;padding:16px 18px;">
                        <div style="font-family:'Courier New',monospace;font-size:9px;font-weight:700;letter-spacing:0.16em;color:#f97316;margin-bottom:10px;">SERVICE CENTRE</div>
                    ...
                    <td width="48%" style="vertical-align:top;background:#f8fafc;border:1px solid #e2e8f0;border-top:3px solid #0066ff;border-radius:10px;padding:16px 18px;">
                        <div style="font-family:'Courier New',monospace;font-size:9px;font-weight:700;letter-spacing:0.16em;color:#0066ff;margin-bottom:10px;">YOUR DETAILS</div>
                ...
                <tr>
                    ...
                    <td width="25%" style="vertical-align:top;">
                        <div style="background:#fef9c3;border:1px solid #fde047;border-radius:8px;padding:12px 14px;">
                            ...
                            <div style="font-family:'Courier New',monospace;font-size:12px;font-weight:700;color:#92400e;">PENDING</div>
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;border-collapse:collapse;">
                <thead>
                    <tr style="background:#0b1120;">
                        ...
                        <th style="font-family:'Courier New',monospace;font-size:10px;color:#94a3b8;padding:10px 14px;text-align:right;letter-spacing:0.1em;width:130px;">AMOUNT</th>
                    </tr>
                </thead>
                <tbody>
                    <tr style="border-bottom:1px solid #f1f5f9;">
                        ...
                        <td style="padding:14px;text-align:right;font-family:'Courier New',monospace;font-size:12px;color:#94a3b8;vertical-align:top;">TBC</td>
                    </tr>
                </tbody>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                    <td style="background:#f0f9ff;border:1px solid #bae6fd;border-left:3px solid #0066ff;border-radius:10px;padding:14px 18px;">
                        <div style="font-family:'Courier New',monospace;font-size:10px;font-weight:700;letter-spacing:0.12em;color:#0369a1;margin-bottom:8px;">WHAT HAPPENS NEXT</div>
                        <div style="font-size:13px;color:#334155;line-height:1.8;">
                            ① The garage will review your booking and confirm it shortly.<br>
                            ② You will receive a confirmation email once approved.<br>
                            ③ Arrive at <strong>{{ $booking->garage->address }}</strong> at the scheduled time.
                        </div>
                    </td>
                </tr>
            </table>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="border-top:1px dashed #e2e8f0;padding-top:24px;text-align:center;">
                        <div style="width:40px;height:40px;background:#fef9c3;border:1px solid #fde047;border-radius:50%;margin:0 auto 12px;line-height:40px;text-align:center;font-size:20px;">
                            &#128336;
                        </div>
                        <div style="font-size:15px;font-weight:700;color:#0f172a;margin-bottom:4px;">Booking submitted successfully!</div>
                        <div style="font-size:12px;color:#64748b;line-height:1.6;">
                            Thank you for choosing <strong style="color:#f97316;">{{ $booking->garage->name }}</strong>.<br>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="text-align:right;vertical-align:middle;">
                        <div style="display:inline-block;background:#fef9c3;border:1px solid #fde047;border-radius:20px;padding:5px 14px;">
                            <span style="display:inline-block;width:6px;height:6px;border-radius:50%;background:#f59e0b;vertical-align:middle;margin-right:5px;"></span>
                            <span style="font-family:'Courier New',monospace;font-size:10px;font-weight:700;color:#92400e;letter-spacing:0.08em;vertical-align:middle;">PENDING</span>
                        </div>
                    </td>
                </tr>
            </table>
