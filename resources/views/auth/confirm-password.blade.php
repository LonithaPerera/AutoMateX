...
<head>
    ...
    <title>AutoMateX — Confirm Password</title>
...
<body>
    ...
    <div class="card">
        ...
        <div class="hint-box">{{ __('app.confirm_password_hint') }}</div>
        ...
        <form method="POST" action="{{ route('password.confirm') }}">
            ...
            <button type="submit" class="btn-primary">{{ __('app.confirm_btn') }}</button>
        </form>
    </div>
