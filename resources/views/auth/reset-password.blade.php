...
<head>
    ...
    <title>AutoMateX — Reset Password</title>
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-input" id="email" type="email" name="email"
                       ...
                       autocomplete="username" placeholder="{{ __('app.ph_your_email') }}">
            </div>

            <div class="form-group">
                <label class="form-label" for="password">{{ __('app.field_new_password') }}</label>
                <div class="pw-wrap">
                    <input class="form-input" id="password" type="password" name="password"
                           required autocomplete="new-password" placeholder="{{ __('app.ph_password_min') }}">
            ...
            <div class="form-group">
                <label class="form-label" for="password_confirmation">{{ __('app.field_confirm_new_pass') }}</label>
                <div class="pw-wrap">
                    <input class="form-input" id="password_confirmation" type="password"
                           name="password_confirmation" required autocomplete="new-password"
                           placeholder="{{ __('app.ph_repeat_new_password') }}">
            ...
            <button type="submit" class="btn-primary">{{ __('app.reset_password_btn') }}</button>
        </form>
