    ...
    <div class="glass-bright rounded-2xl p-5 fade-in fade-in-2 border animate-glow">
        <form method="POST" action="{{ route('vehicles.store') }}">
            ...
            <div class="grid grid-cols-2 gap-3 mb-4">
                <div>
                    <label class="section-label mb-2 block">// make</label>
                ...
                <div>
                    <label class="section-label mb-2 block">// model</label>
            ...
            <div class="grid grid-cols-2 gap-3 mb-4">
                <div>
                    <label class="section-label mb-2 block">// license plate</label>
                ...
                <div>
                    <label class="section-label mb-2 block">// colour</label>
            ...
            {{-- VIN --}}
            <div class="mb-4">
                <label class="section-label mb-2 block">// VIN (optional)</label>
